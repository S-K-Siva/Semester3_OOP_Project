...
class Payment{
    ...
    int Google_Pay(string UserName){
        ...
        cin>>pwd;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/users.txt",ios::in);
        while(!file.eof()){
        ...
        if(confirm_payment == 1){
            fstream file;
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/PaymentHistory.txt",ios::app);
            file<<UserName<<" ";
            if(p1){
                file<<mess_food<<" ";
            }else{
            ...
            file.close();
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Mess.txt",ios::app);
            file << UserName << endl;
            file.close();
...
class Hostel{
    ...
    void structure_hostel_room(int num){
        ...
        if(num == 1){
            //Yamuna
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Yamuna.txt",ios::out);
            for(int i = 1;i<10;i++){
                for(int j = 1;j<=10;j++){
            ...
            //Ganga
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Ganga.txt",ios::out);
            ...
            //Krishna
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Krishna.txt",ios::out);
            for(int i = 0;i<10;i++){
                for(int j = 1;j<=10;j++){
            ...
            //Godavari
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Godavari.txt",ios::out);
             for(int i = 1;i<10;i++){
                for(int j = 1;j<=10;j++){
            ...
            //Kaveri
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Kaveri.txt",ios::out);
            for(int i = 1;i<10;i++){
                for(int j = 1;j<=10;j++){
            ...
            //Narmada
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Narmada.txt",ios::out);
            for(int i = 1;i<10;i++){
                for(int j = 1;j<=10;j++){
    ...
    string Ganga_register(string user_name,int choice){
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Ganga.txt",ios::in);
        ...
        if(available_rooms.size() == 0){
            ...
            cin>>select;
            fstream file2;
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::out | ios::trunc);
            while(!file.eof()){
                string tower_name, room_no, person, category;
            int c_level;
            ...
            file.close();
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Ganga.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
    ...
    string Godavari_register(string user_name,int choice){
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Godavari.txt",ios::in);
        vector<string> available_rooms;
        while(!file.eof()){
            string tower_name, room_no, person, category;
            int c_level;
        ...
        if(available_rooms.size() == 0){
            ...
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Godavari.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
                file2>>tower_name>>room_no>>person>>c_level>>category;
    ...
    string Kaveri_register(string user_name,int choice){
       ...
       int level;
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Kaveri.txt",ios::in);
        vector<string> available_rooms;
        while(!file.eof()){
            string tower_name, room_no, person, category;
            int c_level;
        ...
        if(available_rooms.size() == 0){
            ...
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Kaveri.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
                file2>>tower_name>>room_no>>person>>c_level>>category;
    ...
    string Krishna_register(string user_name,int choice){
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Krishna.txt",ios::in);
        vector<string> available_rooms;
        while(!file.eof()){
            string tower_name, room_no, person, category;
            int c_level;
        ...
        if(available_rooms.size() == 0){
            ...
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Krishna.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
                file2>>tower_name>>room_no>>person>>c_level>>category;
    ...
    string Narmada_register(string user_name,int choice){
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Narmada.txt",ios::in);
        vector<string> available_rooms;
        while(!file.eof()){
            string tower_name, room_no, person, category;
            int c_level;
        ...
        if(available_rooms.size() == 0){
            ...
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Narmada.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
                file2>>tower_name>>room_no>>person>>c_level>>category;
    ...
    string Yamuna_register(string user_name,int choice){
        ...
        cin>>level;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Yamuna.txt",ios::in);
        vector<string> available_rooms;
        while(!file.eof()){
            string tower_name, room_no, person, category;
            int c_level;
        ...
        if(available_rooms.size() == 0){
            ...
            file2.close();
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/hostel.txt",ios::in);
            file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Yamuna.txt",ios::out | ios::trunc);
            while(!file2.eof()){
                string tower_name, room_no, person, category;
                int c_level;
                file2>>tower_name>>room_no>>person>>c_level>>category;
...
class User{
    ...
    void User_Hostel(string UserName){
        ...
        cout << "---------------------------------------------------------------------------------------------------------\n" << endl;
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Hostelers.txt",ios::in);
        while(!file.eof()){
    ...
    void User_transaction(string UserName){
        ...
        int is_student = 0;
        fstream check;
        check.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/users.txt",ios::in);
        while(!check.eof()){
        ...
        check.close();
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/PaymentHistory.txt",ios::in);
        while(!file.eof()){
    ...
    void Create_Account(){
        ...
        cin>>User_Name;
        fstream user_file;
        user_file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/users.txt",ios::in);
        while(!user_file.eof()){
            string user_name, pwd, category;
        ...
        fstream file;
        file.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/users.txt",ios::app);
        if(Pwd == C_Pwd){
            file << User_Name << "\t" << Pwd << "\t" << Category << endl;
            cout << "Did you register Hostel? 1.Register 2.Yes";
            Hostel h;
            fstream file2;
            file2.open("/Users/sivasakthivel/Desktop/C++ Project-Sem3/DataBase/Hostelers.txt",ios::app);
